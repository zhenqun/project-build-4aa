...
public abstract class DefaultAbstractUserDetailsAuthenticationProvider implements
AuthenticationProvider, InitializingBean, MessageSourceAware {
	...
	public Authentication authenticate(Authentication authentication)
			throws AuthenticationException {
		DefaultUsernamePasswordAuthenticationToken token = (DefaultUsernamePasswordAuthenticationToken)authentication;
		String tokenType = StringUtils.toString(token.getTokenType());
		Assert.isInstanceOf(DefaultUsernamePasswordAuthenticationToken.class, authentication,
				messages.getMessage(
						"AbstractUserDetailsAuthenticationProvider.onlySupports",
						"Only DefaultUsernamePasswordAuthenticationToken is supported"));
		...
		if (user == null) {
			...
			try {
				...
				User u = (User)user;
				if(u.isNeedCa()){
					if(!tokenType.equals("ca")){
						throw new CaLoginValidateFailException("您必须使用证书登录");
					}
				}
			}
	...
	protected Authentication createSuccessAuthentication(Object principal,
		...
		DefaultUsernamePasswordAuthenticationToken result = new DefaultUsernamePasswordAuthenticationToken(
	...
	public boolean supports(Class<?> authentication) {
		return (DefaultUsernamePasswordAuthenticationToken.class
