(function () {
    ...
    $(window).on('load', function () {
        ...
        $('[name="validateCode"]').on('blur', function () {
            ...
            $.get('/sso/checkValidateCode/' + code + '/').then(function (data) {
                console.log(data);
                if(data){
            ...
            $('#sms-btn').on('click', function () {
                ...
                if (tel != null || tel != '') {
                    $.get({
                        url: '/sso/common/checkPhoneRegist/' + tel + '/',
                        cache: false
                    }).then(function (data) {
                        console.log(data);
                        if (!data) {
                            $('#errtelePhone').addClass('hide');
                            return $.get('/sso/checkValidateCode/' + $.trim($validCode.val())+ '/');
                        }
