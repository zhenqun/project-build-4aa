 ...
 */
@Named
public class CancelSecurityUserListener implements ApplicationListener<CancelSecurityUserEvent> {
	...
	@Override
	public void onApplicationEvent(CancelSecurityUserEvent event) {
