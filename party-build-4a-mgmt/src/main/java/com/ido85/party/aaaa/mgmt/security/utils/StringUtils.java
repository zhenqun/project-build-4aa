...
//	}
	 ...
	 */
	public static String getUserNameIDHash(String username,String id){
		log.info("-------------准备转化idcard:"+id);
		String idCard = id.toUpperCase();
		log.info("-------------转化idcard成功:"+idCard);
		StringBuffer userInfo=new StringBuffer();
		userInfo.append(idCard.toUpperCase()).append(username);
		log.info("-------------生成hash:"+sha1IdAndName(userInfo.toString()));
	...
	public static boolean validatePassword(String password) {
		boolean flag = false;
		String regex = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)[a-zA-Z\\d]{8,18}$";
		try {
