 ...
 */
@Named
public class SetSecurityUserManageListener implements ApplicationListener<SetSecurityUserEvent> {
	...
	@Transactional
	@Async
	public void onApplicationEvent(SetSecurityUserEvent event) {
