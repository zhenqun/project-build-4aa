...
@Named
public class InternetLogApplicationImpl extends BaseApplication implements InternetLogApplication {
	...
	public List<OutRegisterLogQueryDto> queryRegisterLog(InRegisterLogQueryDto in) throws Exception {
		...
		return this.queryPageEntityNodesForInternet(sql.toString(), params, in.getPageSize(), in.getPageNo(), OutRegisterLogQueryDto.class);
	}
	...
	public Long queryRegisterLogCount(InRegisterLogQueryDto in) throws Exception {
		...
		return this.queryPageEntityCountForInternet(sql.toString(), params);
	}
	...
	public List<OutLoginLogQueryDto> queryLoginLog(InLoginLogQueryDto in) throws Exception {
		...
		return this.queryPageEntityNodesForInternet(sql.toString(), params, in.getPageSize(), in.getPageNo(), OutLoginLogQueryDto.class);
	}
