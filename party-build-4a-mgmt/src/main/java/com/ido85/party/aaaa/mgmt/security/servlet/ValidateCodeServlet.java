 ...
 */
package com.ido85.party.aaaa.mgmt.security.servlet;
...
public class ValidateCodeServlet extends HttpServlet {
	...
	private void createBackground(Graphics g) {
		// 填充背景
		g.setColor(getRandColor(245,255)); 
		g.fillRect(0, 0, w, h);
		// 加入干扰线条
		/*for (int i = 0; i < 8; i++) {
	...
	private String createCharacter(Graphics g) {
		...
		for (int i = 0; i < 4; i++) {
			...
			g.setFont(new Font(fontTypes[random.nextInt(fontTypes.length)],Font.PLAIN,22)); 
