 ...
 */
@Named
public class ExportAuditorCodeListener implements ApplicationListener<ExportAuditorCodeEvent> {
	...
	@Transactional
	@Async
	public void onApplicationEvent(ExportAuditorCodeEvent event) {
