 ...
 */
@Named
public class CancelBusinessUserListener implements ApplicationListener<CancelBusinessUserEvent> {
	...
	@Override
	public void onApplicationEvent(CancelBusinessUserEvent event) {
