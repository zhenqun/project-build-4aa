 ...
 */
@Named
public class ModBusinessUserStateListener implements ApplicationListener<ModBusinessUserStateEvent> {
	...
	@Override
	public void onApplicationEvent(ModBusinessUserStateEvent event) {
