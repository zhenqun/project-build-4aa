 ...
 *   configurable instances of {@link HierarchicalCache} for each of
 ...
 *
 */
public class HierarchicalCacheManager extends AbstractCacheManager {
    ...
    protected final ICache<TemplateCacheKey, TemplateModel> initializeTemplateCache() {
        ...
        return new HierarchicalCache<TemplateCacheKey, TemplateModel>(
